# -*- coding: utf-8 -*-
"""LVADSUSR124_sushil -Classification

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12Vw9Le-UiLzFfuxZrfWmNKrp4VSoLbXL
"""
...
print(data.shape)
## from the output we can seee that there is no missing values
...
## identifying and spliting features and labels
...
## using classification training and testing the model
